...
<div align=center>
## Figure 1: GTA Shelter Population
...
**Figure 1. Total Shelter Population within the Greater Toronto Area (GTA).** The total number of shelter users for each <u>recorded</u> **Occupancy Date** were plotted for the period of 2021-01-01 to 2024-03-29. The number of shelter users have increased by more than 60% over this time span. These numbers are obviously an underestimate of the "*true*" demand for these types of services given the many other homeless individuals who are not accounted for by these records.

<br>
<br>

<div align=center>
## Figure 2: GTA Shelter Population
### (Regional Numbers)
...
**Figure 2. Shelter Population per GTA region.** The total number of shelter users for each region of the **GTA** (i.e. Toronto, North York, Etobicoke, Scarborough, Vaughan) were plotted for the indicated time period (2021-01-01 to 2024-03-29). The disparity in the number of shelter users per region shows that the vast majority of shelter users are currently being housed within Toronto and North York (see Bar graph below).

<br>
<br>

<div align=center>
## Figure 3: GTA Shelter Population
...
<div align=center>
## Figure 4: GTA Shelter Population
...
**Figure 4. Homeless Population Demographics within the GTA Region.** The above graph looks at some common demographic variables of the **GTA** homeless population. The number of individuals within each of these designated groups (i.e. **men**, **women**, **families**, **Youth** and **Mixed adults**) have been rapidly increasing within the shelter system over the last 3 years. The **Youth** and **Mixed adult** populations also show considerable fluctuations in their numbers over the latter part of this time period. 

<br>
<br>

<div align=center>
## Figure 5: GTA Shelter Population
...
<div align=center>
## Figure 6: GTA Shelter Population
...
<div align=center>
## Figure 9: Homes First Delta Hotel Shelter
### (# Unavailable Rooms)
